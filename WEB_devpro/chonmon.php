...
<form action='' enctype='multipart/form-data' method='post'>
	...
	"
		...
		<p><input type='submit' class='btn btn-danger' name='OK' value='OK'><font color='black'>   Nhấn Ok để submit!</font>
		</p>  
</li></ul>
...
if(isset($_POST['OK']))
{
	...
	{
		if(is_dir("D:/workingDir/$mon_hoc/$MSSV"))
		{
		...
		if(file_exists("D:/workingDir/$mon_hoc/$MSSV/maxScore.csv") &&(file_exists("D:/workingDir/$mon_hoc/$MSSV/scoreOfSV.csv")))
		{
		$duongdan_1="D:/workingDir/$mon_hoc/$MSSV/maxScore.csv";
		$duongdan_2="D:/workingDir/$mon_hoc/$MSSV/scoreOfSV.csv";
